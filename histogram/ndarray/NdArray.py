...
class NdArray(object):
    ...
    def __mul__(self, other): self._nie("__mul__")


    def __rmul__(self, other): self._nie("__rmul__")
    
            
    def __add__(self, other): self._nie("__add__")


    def __radd__(self, other): self._nie("__radd__")


    def __sub__(self, other): self._nie("__sub__")


    def __rdiv__(self, other): self._nie("__rdiv__")


    def __div__(self, other): self._nie("__div__")
